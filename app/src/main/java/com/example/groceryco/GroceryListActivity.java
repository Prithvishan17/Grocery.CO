...
import com.example.groceryco.adapter.MenuListAdapter;
...
public class GroceryListActivity extends AppCompatActivity implements MenuListAdapter.MenuListClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle(groceryModel.getName());
        actionBar.setDisplayHomeAsUpEnabled(true);


        menuList = groceryModel.getMenus();
        initRecyclerView();
        ...
        buttonCheckout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(itemsInCartList != null && itemsInCartList.size() <= 0) {
                    Toast.makeText(GroceryListActivity.this, "Please add some items in cart.", Toast.LENGTH_SHORT).show();
                    return;
                }
                groceryModel.setMenus(itemsInCartList);
                Intent i = new Intent(GroceryListActivity.this, PlaceYourOrderActivity.class);
                i.putExtra("GroceryModel", groceryModel);
